...
namespace Biblioteca_ProyectoBDII.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public AutorsController(BibliotecaProyect_BDIIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAutor,NombreAutor,Estado,FechaCreacion")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,NombreAutor,Estado,FechaCreacion")] Autor autor)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotecaProyect_BDIIContext.Autors'  is null.");
            }
            var autor = await _context.Autors.FindAsync(id);
            if (autor != null)
            {
